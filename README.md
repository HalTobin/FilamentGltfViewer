...
- *gltf-viewer* sample available on the filament's repository: [https://github.com/google/filament/tree/main/ios/samples/gltf-viewer](https://github.com/google/filament/tree/main/ios/samples/gltf-viewer)
- *hello-ar* sample available on the filament's repository: [https://github.com/google/filament/tree/main/ios/samples/hello-ar](https://github.com/google/filament/tree/main/ios/samples/hello-ar)
...
2. Make sure you have the following folders: *filament* and *FilamentGltfViewer* in your workspace (root folder).
3. Open *filament* and run the following commands: 
    `sh ./build.sh -p ios -i debug` and `sh ./build.sh -p ios -i release`
    Note, that the building process will take a few minutes.
4. Return to the workspace's folder and run:
    `sh build.sh`
...
- SPM implementation
- Basic documentation
- Complete script to build .xcframework (filament build + xcframework build)